 ...
 *      '1999.09.18 (Modified by Lee, S.M.)
 *		'2002.01.02 (Modified by Lee, S.M.)
 * 
 *      Compiler : Turbo C, DJGPP, GCC (Unix/Linux)
 *      Compile  : tcc hfn2fnt.c
 *                 gcc -Wall hfn2fnt.c -o hfn2fnt.exe
 */
